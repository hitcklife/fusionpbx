...
// Set field values
$call_flow_name = $request['call_flow_name'];
$call_flow_extension = $request['call_flow_extension'];
$call_flow_feature_code = $request['call_flow_feature_code'] ?? '';
$call_flow_status = $request['call_flow_status'] ?? 'false';
$call_flow_pin_number = $request['call_flow_pin_number'] ?? '';
$call_flow_label = $request['call_flow_label'] ?? '';
$call_flow_sound = $request['call_flow_sound'] ?? '';
$call_flow_alternate_label = $request['call_flow_alternate_label'] ?? '';
$call_flow_alternate_sound = $request['call_flow_alternate_sound'] ?? '';
$call_flow_app = $request['call_flow_app'] ?? 'transfer';
$call_flow_data = $request['call_flow_data'] ?? '';
$call_flow_alternate_app = $request['call_flow_alternate_app'] ?? 'transfer';
$call_flow_alternate_data = $request['call_flow_alternate_data'] ?? '';
$call_flow_context = $request['call_flow_context'] ?? $domain_name;
$call_flow_enabled = $request['call_flow_enabled'] ?? 'true';
$call_flow_description = $request['call_flow_description'] ?? '';
