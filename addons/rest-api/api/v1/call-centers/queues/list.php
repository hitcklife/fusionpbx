...
// Filters
$filters = get_filter_params(['queue_strategy']);
$filter_result = api_build_filters($filters, ['queue_strategy']);
...
$sql = "SELECT call_center_queue_uuid, queue_name, queue_extension, queue_strategy,
        ...
        queue_announce_sound, queue_announce_frequency, queue_description
